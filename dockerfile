# THIS FILE IS FOR DEVELOPMENT USE ONLY. IT DOES NOT INCLUDE THE DATABASE. YOU MUST ONLY USE THIS FOR DEVELOPMENT OR IF YOU WISH TO BUILD YOUR OWN IMAGE. 
# WE DO NOT PROVIDE SUPPORT FOR THE DOCKERFILE TEMPLATE AND IS PROVIDED AS-IS.
